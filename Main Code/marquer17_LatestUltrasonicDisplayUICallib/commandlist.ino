...
void nextCommand() {
  if (nextStep < commandList.size()) {
      ...
      commandListExecutionTime = commandListEndTime-commandListStartTime;
      executingCommandList = false;
      Serial.println("Commandlist complete! No more steps. Time Taken: " + String(commandListExecutionTime) + "");
      //Change UI Page
      uiPage = 6;
